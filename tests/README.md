...
Hors périmètre pour l'instant (tests d'intégration/routes HTTP, pas des tests unitaires) : les routes Flask elles-mêmes (`register`, `login`, `like_profile`, `send_message`, etc.), qui mêlent session/requête HTTP et logique métier.
